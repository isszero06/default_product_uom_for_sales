{
    ...
    'description': """
        In Odoo, as a standard, there are two fields in the item data to define the units
First field:
“Unit of Measure” is unfortunately used as a default unit for inventory and also as a default unit for sale,
...
Second field:
"Purchase UoM"
In this field, the default unit for purchase orders is defined, but it does not work when creating a manual invoice or creating a manual refund, and the default unit in this case is “Unit of Measure”.
